...
function build() {
  ...
  const bodyHtml = `
    ...
    ${step(2, 'สร้าง Agent ใหม่', `
      ...
      ${promptBox('ตัวอย่าง Instructions เบื้องต้น — Copy ไปวางในช่อง Instructions ได้เลย', 'Role: คุณคือ HR Assistant ของบริษัท\nTask: ตอบคำถามพนักงานเกี่ยวกับนโยบายบริษัท\nScope: ใช้ข้อมูลจากเอกสารที่แนบไว้เท่านั้น ห้ามตอบจากความรู้ทั่วไป\nRule: ถ้าไม่พบข้อมูลในเอกสาร ให้บอกตามตรงว่าไม่พบ และแนะนำให้ติดต่อ HR โดยตรง / ตอบเป็นภาษาไทยเสมอ\nTone: สุภาพ เป็นทางการพอประมาณแบบเจ้าหน้าที่ HR')}
    ...
    ${step(6, 'ปิด Web Search และปิด Ungrounded Responses แล้วทดสอบ', `
      ...
      ${promptBox('ตัวอย่าง Instructions สำหรับ Warehouse — Copy ไปปรับใช้ได้', 'Role: คุณคือ Warehouse Safety Assistant ของบริษัท\nTask: ตอบคำถามพนักงานคลังสินค้าเกี่ยวกับความปลอดภัยและอุปกรณ์ PPE\nScope: ใช้ข้อมูลจากเอกสารที่แนบไว้เท่านั้น ห้ามตอบจากความรู้ทั่วไป\nRule: ถ้าไม่พบข้อมูลในเอกสาร ให้บอกตามตรงว่าไม่พบ และแนะนำให้ติดต่อฝ่ายความปลอดภัยโดยตรง / ตอบเป็นภาษาไทยเสมอ\nTone: หนักแน่น จริงจัง เน้นความปลอดภัยเป็นหลัก')}
    `)}
